...
#  Information: Please don't forget to check your php.ini file for "upload_max_filesize", 
...
class Uploader {
    ...
    private function validate($file = null){
        ...
        if($file == null){
            ...
            if($file['size'] > $options['maxSize']) $errors[] = $this->error_messages['max_file_size'];
            //echo $file['size'];exit;
